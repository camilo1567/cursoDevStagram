    ...
    <div class="flex justify-center">
        <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            <div class="md:w-8/12 lg:w-6/12 px-5">
                <img src="{{ $user->imagen ? asset('perfiles').'/'. $user->imagen : asset('img/usuario.svg') }}" alt="Perfil">
            </div>
            <div class="w-8/12 lg:w-6/12 px-5 flex flex-col items-center py-10 md:items-start md:py-10 md:justify-between">
