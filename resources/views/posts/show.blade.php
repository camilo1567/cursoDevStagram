            ...
            <div class="shadow bg-white p-5 mb-5 ">
                ...
                @auth
                    ...
                    <form action="{{ route('comentarios.store',['post' => $post,'user' =>$user]) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea id="comentario" name="comentario" placeholder="Comentario" class="border p-3 w-full rounded-lg 
                ...
                <div class="bg-white shadow mb-5 max-h-96 overflow-y-auto">
                    @if ($post->comentarios->count())
                        ...
                        @endforeach
                    @else
                        <p class="p-10 text-center mt-10">No Hay Comentarios Aun</p>
                    @endif
                </div>
